 ...
 * 简繁体转换
 */
let chinese = require('../lang/zh.js');
...
function chineseLanguageLoader ( options, loaderContext )
{
    let modulesOptions = {
        language: 'zh-TW'
    };
    if ( typeof options.language === 'string') { 
        modulesOptions.language = ( options.language === 'zh-CN' ? options.language : 'zh-TW' );
    }
